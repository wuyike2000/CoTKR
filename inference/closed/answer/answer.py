...
if KR=='triple':
    ...
    test=json.load(open('../rewrite/result/'+DATA+'/'+LLM+'/'+KR+'.json','r',encoding='utf-8'))
...
# result
if KR=='triple':
    result='result/'+ANS+'/'+DATA+'/triple.json'
    os.makedirs('result/'+ANS+'/'+DATA,exist_ok = True)
    log_file='log/'+ANS+'/'+DATA+'/triple.log'
    os.makedirs('log/'+ANS+'/'+DATA,exist_ok = True)
else:
    result='result/'+ANS+'/'+DATA+'/'+LLM+'/'+KR+'.json'
    os.makedirs('result/'+ANS+'/'+DATA+'/'+LLM,exist_ok = True)
    log_file='log/'+ANS+'/'+DATA+'/'+LLM+'/'+KR+'.log'
    os.makedirs('log/'+ANS+'/'+DATA+'/'+LLM,exist_ok = True)
